...
<title>Find Workers — JointU Client</title>
...
<main class="app-main">
  ...
  <div class="app-content">
    <div class="card" style="text-align:center;padding:60px 24px">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--border)" stroke-width="1.5" style="margin:0 auto 16px"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
      <div style="font-weight:700;font-size:1rem;margin-bottom:6px">Worker directory coming soon</div>
      <div class="text-sm-muted">Search and invite skilled workers to your jobs.</div>
    </div>
  </div>
</main>
</div>
