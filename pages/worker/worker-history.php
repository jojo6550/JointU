...
<title>JointU – Job History</title>
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="../worker/worker-history.php" class="active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>History</a>
...
<main class="app-main">
  <header class="app-header">
    <div class="app-header-title">
      <h2>Job History</h2>
      <p>Your track record of excellence.</p>
    </div>
  </header>
  <div class="app-content">
    <div class="card" class="mb-14">
      <div class="d-flex items-center gap-14">
        <div class="avatar-mint-40">✓</div>
        <div class="flex-1"><div class="text-lg-700">Fence Painting</div><div class="text-sm-muted-2">Michelle Barker · Oct 15, 2024</div></div>
        <div class="text-right" class="mr-20"><div class="label-muted">Earned</div><div class="text-800">JMD 15,000</div></div>
        <div class="text-right" class="mr-16"><div class="label-muted">Rating</div><div class="text-amber">★★★★★</div></div>
    ...
    <div class="card" class="mb-14">
      <div class="d-flex items-center gap-14">
        <div class="avatar-mint-40">✓</div>
        <div class="flex-1"><div class="text-lg-700">AC Filter Update</div><div class="text-sm-muted-2">David Lewin · Oct 10, 2024</div></div>
        <div class="text-right" class="mr-20"><div class="label-muted">Earned</div><div class="text-800">JMD 8,000</div></div>
        <div class="text-right" class="mr-16"><div class="label-muted">Rating</div><div class="text-amber">★★★★<span style="color:var(--border)">★</span></div></div>
        <button class="btn btn-ghost btn-sm">Review</button>
      </div>
    </div>
    <div class="card">
      <div class="d-flex items-center gap-14">
        <div class="avatar-mint-40">✓</div>
        <div class="flex-1"><div class="text-lg-700">Office Full Rewiring</div><div class="text-sm-muted-2">Jason R. · Sep 28, 2024</div></div>
        <div class="text-right" class="mr-20"><div class="label-muted">Earned</div><div class="text-800">JMD 80,000</div></div>
        <div class="text-right" class="mr-16"><div class="label-muted">Rating</div><div class="text-amber">★★★★★</div></div>
        <button class="btn btn-ghost btn-sm">Review</button>
      </div>
    </div>
