...
<title>JointU – My Earnings</title>
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="../worker/worker-payments.php" class="active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>Payments</a>
...
<main class="app-main">
  ...
  <div class="app-content">
    <div class="card">
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <tr>
              <td><strong>Office Full Rewiring</strong></td>
              <td>Jason R.</td>
              <td><strong>JMD 80,000</strong></td>
              ...
              <td>
                <label style="display:flex;align-items:center;gap:8px;font-size:.82rem;cursor:pointer">
                  <input type="checkbox" style="accent-color:var(--mint)">
                  I Received Payment
                </label>
              </td>
            </tr>
            <tr>
              <td><strong>Fix Leaking Garden Pipe</strong></td>
              <td>Alicia S.</td>
              <td><strong>JMD 6,500</strong></td>
              <td><span class="badge badge-green">✓ Paid</span></td>
              <td>
                <label style="display:flex;align-items:center;gap:8px;font-size:.82rem;cursor:pointer">
                  <input type="checkbox" checked style="accent-color:var(--mint)">
                  I Received Payment
                </label>
              </td>
            </tr>
    ...
    <div style="background:var(--ink);border-radius:var(--r-lg);padding:18px 22px;display:flex;align-items:center;justify-content:space-between;margin-top:20px;flex-wrap:wrap;gap:14px">
      <div class="d-flex items-center gap-14">
        <div style="width:38px;height:38px;background:rgba(0,200,150,.15);border-radius:8px;display:flex;align-items:center;justify-content:center">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--mint)" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
        </div>
        <div>
          <strong style="color:var(--white);font-size:.9rem;display:block">Set up digital payments</strong>
          <p style="color:rgba(255,255,255,.5);font-size:.8rem">Enable automatic secure transfers and escrow coverage.</p>
        </div>
      </div>
      <button class="btn btn-ghost" style="background:rgba(255,255,255,.1);color:var(--white);border-color:rgba(255,255,255,.3)">Connect Wallet</button>
    </div>
  </div>
</main>
</div>
