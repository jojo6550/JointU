...
<title>Disputes — JointU Worker</title>
  ...
  <main class="app-main">
    <header class="app-header">
      <div class="app-header-title">
        <h2>Worker Support &amp; Disputes</h2>
        <p>Protecting your business rights and reputation.</p>
      </div>
    </header>

    <div class="app-content">
      <div class="card" style="text-align:center;padding:48px 24px">
        <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="var(--mint)" stroke-width="1.5" style="margin:0 auto 16px"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        <h3 class="mb-8">No active disputes</h3>
        <p style="color:var(--muted);font-size:.88rem">Great job! You have a clean record. Keep providing excellent service to avoid future disputes.</p>
      </div>
    </div>
  </main>
</div>
